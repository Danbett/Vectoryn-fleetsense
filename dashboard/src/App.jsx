...
export default function App() {
  ...
  return(<div style={{display:'flex',height:'100vh',background:'#0D1B2A',overflow:'hidden'}}>
    ...
    <div style={{flex:1,display:'flex',flexDirection:'column',overflow:'hidden'}}>
      ...
      <div style={{flex:1,overflow:isMap?'hidden':'auto'}}>{renderModule(activeModule,setActiveModule)}</div>
    </div>
